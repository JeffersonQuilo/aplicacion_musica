...
public class FrmUsuario extends javax.swing.JInternalFrame {
   ...
   //--------------------PRESENTACION DE JTABLE----------------------
    ...
    private void initComponents() {
        ...
        pBuscar.setBackground(new java.awt.Color(0, 255, 102));
        ...
        pBuscar.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 80, 430, 210));
        ...
        pNuevo.setBackground(new java.awt.Color(0, 255, 102));
        ...
        btnCancion.setBackground(new java.awt.Color(255, 255, 255));
        btnCancion.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Presentacion/cancion.png"))); // NOI18N
        ...
        pNuevo.add(btnCancion, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 70, -1, -1));

        btnlista.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Presentacion/lista.png"))); // NOI18N
        ...
        tabUsuario.setBounds(10, 10, 510, 370);
        tabUsuario.getAccessibleContext().setAccessibleName("Buscar");

        btnNuevo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Presentacion/nuevo cliente.png"))); // NOI18N
        ...
        btnNuevo.setBounds(540, 50, 110, 33);

        btnGuardar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Presentacion/GUARDAR.png"))); // NOI18N
        ...
        btnGuardar.setBounds(540, 90, 110, 33);

        btnModificar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Presentacion/modificar.png"))); // NOI18N
        ...
        btnModificar.setBounds(540, 130, 110, 33);

        btnCancelar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Presentacion/cancelar.png"))); // NOI18N
        ...
        btnCancelar.setBounds(540, 170, 110, 33);

        btnSalir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Presentacion/SALIR1.png"))); // NOI18N
        ...
        btnSalir.setBounds(550, 210, 90, 33);

        jLabel1.setText("Controles");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(570, 30, 60, 20);
